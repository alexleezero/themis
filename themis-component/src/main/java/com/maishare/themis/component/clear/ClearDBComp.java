 ...
 * Clear db 组件
 * @author moushaokun
 * @version @Id: ClearDBComp.java, v 0.1 2020年03月11日 14:11 moushaokun Exp $
 */
public class ClearDBComp extends ClearComponent<CommonIndexCompParam> {

    private static final Logger          LOGGER          = LoggerFactory
        .getLogger(ClearDBComp.class);
    ...
    public void act(ThemisTestExecution themisTestExecution, CommonIndexCompParam commonIndexCompParam) {
        LOGGER.debug("清理数据，参数: " + commonIndexCompParam.toString());
        ...
        operationalComp.checkSupportType("清理数据", operations, DBOperationType.INSERT, DBOperationType.DELETE, DBOperationType.UPDATE);
